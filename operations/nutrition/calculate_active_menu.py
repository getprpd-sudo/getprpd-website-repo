...
INGREDIENTS: dict[str, Ingredient] = {
    ...
    "small_tortilla": Ingredient("Mission Carb Balance small tortilla", n(70, 6, 19, 15, 2.5, 0, 0, 0, 320, 0), "each", f"{MANUFACTURER}; PRPD package record", "medium", "Fat and sodium are working product estimates; photograph the current package before label printing."),
